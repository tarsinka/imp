...
let xor_ r1 r2 r3 = ins "xor %s, %s, %s" r1 r2 r3
let neg r1 r2 = ins "neg %s, %s" r1 r2
let sll r1 r2 r3 = ins "sll %s, %s, %s" r1 r2 r3
let srl r1 r2 r3 = ins "srl %s, %s, %s" r1 r2 r3
let rol r1 r2 r3 = ins "rol %s, %s, %s" r1 r2 r3
let ror r1 r2 r3 = ins "ror %s, %s, %s" r1 r2 r3
...
let nop = Nop
let move r1 r2 = if r1 = r2 then nop else ins "move %s, %s" r1 r2
...
let ( @@ ) x y = C (x, y)
let push r = subi sp sp 4 @@ sw r 0 sp
